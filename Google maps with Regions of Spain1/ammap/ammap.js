...
(function () {
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e)for (var g = 0; g < a[c].length; g++)e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][g], e); else"object" == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c], e)) : b.setAttribute(c, a[c])
        }
    }
})();
(function () {
    ...
    d.AmDraw = d.Class({
        construct: function (a, b, c, e) {
            ...
            if (d.hasSVG) {
                ...
                a && (a.addCodeCredits && b.appendChild(document.createTextNode("" + a.version)), c.appendChild(b), a.defs && (b = this.createSvgElement("defs"), c.appendChild(b), d.parseDefs(a.defs, b), this.defs = b))
            }
        }
    })
})();
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (b.container && !1 !== a.enabled) {
                ...
                var c = a.y, e = a.text, g = a.align, f = a.size, h = a.color, k = a.rotation, l = a.alpha, m = a.bold, n = d.toCoordinate(a.x, b.realWidth), c = d.toCoordinate(c, b.realHeight);
                n || (n = 0);
                c || (c = 0);
                void 0 === h && (h = b.color);
            ...
            if (this.animations)for (a = this.animations.length - 1; 0 <= a; a--) {
                ...
                } else g.node.style[f] = Number(b.to) +
                    b.suffix, g.animationFinished = !0, this.animations.splice(a, 1)
            }
        }, update: function () {
            ...
            if (!this.hideCredits) {
                ...
                if (c != a || !0 === this.inIframe()) {
                    ...
                    var h = a + "/javascript-charts/", k = "JavaScript charts", l = "";
    ...
    d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    var h = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, q = this.fillColor, r = this.borderColor, t = q;
                    void 0 != n && (this.adjustBorderColor ? t = r = n : q = n);
                    var p = this.horizontalPadding, y = this.verticalPadding, B = this.pointerWidth, u = this.pointerOrientation, w = this.cornerRadius, v = c.fontFamily, A = this.fontSize;
                    ...
                    C.position = "absolute";
                    var x = this.minWidth, z = "";
                    isNaN(x) || (z = "min-width:" + (x - 2 * p) + "px; ");
                    ...
                    x < h && (x = h);
                    x + z > l && (x = l - z);
                    var k = A + y, m = x + p, G = this.shadowAlpha, D = this.shadowColor, p = this.borderThickness, K = this.bulletSize, J, y = this.fillAlpha, L = this.borderAlpha;
                    this.showBullet && (J = d.circle(g, K, t, y), f.push(J));
                    this.drop ? (h = z / 1.6, l = 0, "V" == u && (u = "down"), "H" == u && (u = "left"), "down" == u && (x = a + 1, A = b - h - h / 3), "up" == u && (l = 180, x = a + 1, A = b + h + h / 3), "left" == u && (l = 270, x = a + h + h / 3 + 2, A = b), "right" == u && (l = 90, x = a - h - h / 3 + 2, A = b), k = A - E / 2 + 1, m = x - F / 2 - 1, q = d.drop(g, h, l, q, y, p, r, L)) : 0 < w || 0 === B ? (0 < G && (a = d.rect(g, z, v, q, 0, p + 1, D, G, w), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(g, z, v, q, y, p, r, L, w)) : (t = [], w = [], "H" != u ? (h = a - x, h > z - B && (h = z - B), h < B && (h = B), t = [0, h - B, a - x, h + B, z, z, 0, 0], w = H ? [0, 0, b - A, 0, 0, v, v, 0] : [v, v, b - A, v, v, 0, 0, v]) : (u = b - A, u > v - B && (u = v - B), u < B && (u = B), w = [0, u - B, b - A, u + B, v, v, 0, 0], t = a < h + (l - h) / 2 ? [0, 0, x < a ? 0 : a - x, 0, 0, z, z, 0] : [z, z, x + z > a ? z : a - x, z, z, 0, 0, z]), 0 < G && (a = d.polygon(g, t, w, q, 0, p, D, G), a.translate(1, 1), f.push(a)), q = d.polygon(g, t, w, q, y, p, r, L));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({translate: x - g + "," + A}, b, "easeOutSine"), n && (C.left = this.prevTX + "px", C.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = x - g;
                    this.prevY = A;
                    this.prevTX = m;
                    this.prevTY = k
...
(function () {
    ...
    d.polygon = function (a, b, c, e, g, f, h, k, l, m, n) {
        ...
        isNaN(k) && (k = g);
        var q = e, r = !1;
        "object" == typeof q && 1 < q.length && (r = !0, q = q[0]);
        void 0 === h && (h = q);
    ...
    d.rect = function (a, b, c, e, g, f, h, k, l, m, n) {
        ...
        void 0 !== n && 0 < n && (g["stroke-dasharray"] = n);
        a = a.rect(t, p, b, c, l, f).attr(g);
        r && a.gradient("linearGradient", e, m);
        return a
    };
    d.bullet = function (a, b, c, e, g, f, h, k, l, m, n, q, r) {
        var t;
        "circle" == b && (b = "round");
        switch (b) {
            case"round":
            ...
            case"square":
                t = d.polygon(a, [-c /
                2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180, void 0, r);
                break;
            case"rectangle":
                t = d.polygon(a, [-c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180, void 0, r);
                break;
            case"diamond":
    ...
    d.makeHD = function (a, b, c) {
        for (var e = [], d = [], f = 1; f < a.length; f++)for (var h = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.round(Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - h) / n, m = (m - k) / n, q = 0; q <= n; q++) {
            var r = k + q * m + Math.random() * c;
    ...
    d.handDrawnLine = function (a, b, c, e, g, f, h, k, l, m) {
        var n, q = a.set();
        for (n = 1; n < b.length; n++)for (var r = [b[n - 1], b[n]], t = [c[n - 1], c[n]], t = d.makeHD(r, t, a.handDrawScatter), r = t[0], t = t[1], p = 1; p < r.length; p++)q.push(d.line(a, [r[p - 1], r[p]], [t[p - 1], t[p]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return q
    };
    d.doNothing =
        function (a) {
    ...
    d.drop = function (a, b, c, e, d, f, h, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b, r = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, p = .8 * b, y = -b / 3, B = b / 3;
        0 === c && (y = -y, B = 0);
        180 == c && (B = 0);
        90 == c && (y = 0);
        270 == c && (y = 0, B = -B);
        c = {fill: e, stroke: h, "stroke-width": f, "stroke-opacity": k, "fill-opacity": d};
        b = "M" + n + "," + q + " A" + b + "," + b + ",0,1,1," + r + "," + t + (" A" + p + "," + p + ",0,0,0," + (Math.sin((m + 20) * l) * b + B) + "," + (Math.cos((m + 20) * l) * b + y));
        b += " A" + p + "," + p + ",0,0,0," + n + "," + q;
        return a.path(b, void 0, void 0, "1000,1000").attr(c)
    };
    d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, q, r, t) {
        var p = Math.round;
        f = p(f);
        h = p(h);
        k = p(k);
        var y = p(h / f * k), B = d.VML, u = 359.5 + f / 100;
        359.94 < u && (u = 359.94);
        g >= u && (g = u);
        var w = 1 / 180 * Math.PI, u = b + Math.sin(e * w) * k, v = c - Math.cos(e * w) * y, A = b + Math.sin(e * w) * f, C = c - Math.cos(e * w) * h, x = b + Math.sin((e + g) * w) * f, z = c - Math.cos((e + g) * w) * h, F = b + Math.sin((e + g) * w) * k, w = c - Math.cos((e + g) * w) * y, E = {
        ...
        e = a.set();
        var G;
        B && (u = p(10 * u), A = p(10 * A), x = p(10 * x), F = p(10 * F), v = p(10 * v), C = p(10 * C), z = p(10 * z), w = p(10 * w), b = p(10 * b), l = p(10 * l), c = p(10 * c), f *= 10, h *= 10, k *= 10, y *= 10, 1 > Math.abs(g) && 1 >= Math.abs(x - A) && 1 >= Math.abs(z - C) && (G = !0));
        g = "";
        var D;
        q && (E["fill-opacity"] = 0, E["stroke-opacity"] = m["stroke-opacity"] / 2, E.stroke = m.stroke);
        if (0 < l) {
            D = " M" + u + "," + (v + l) + " L" + A + "," + (C + l);
            B ? (G || (D += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + x + "," + (z + l)), D += " L" + F + "," + (w + l), 0 < k && (G || (D += " B" + (b - k) + "," + (l + c - y) + "," + (b + k) + "," +
                    (l + c + y) + "," + F + "," + (l + w) + "," + u + "," + (l + v)))) : (D += " A" + f + "," + h + ",0," + H + ",1," + x + "," + (z + l) + " L" + F + "," + (w + l), 0 < k && (D += " A" + k + "," + y + ",0," + H + ",0," + u + "," + (v + l)));
            D += " Z";
            var K = l;
            B && (K /= 10);
        ...
        B ? (G || (g = " A" + p(b - f) + "," + p(c - h) + "," + p(b + f) + "," + p(c + h) + "," + p(A) + "," + p(C) + "," + p(x) + "," + p(z)), h = " M" + p(u) + "," + p(v) + " L" + p(A) + "," + p(C) + g + " L" + p(F) + "," + p(w)) : h = " M" + u + "," + v + " L" + A + "," + C + (" A" + f + "," + h + ",0," + H + ",1," + x + "," + z) + " L" + F + "," + w;
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft +
                this.titleWidth, c = this.marginRight, e = this.marginTop, g = this.marginBottom, f = this.horizontalGap, h = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, r = 0, t = 0, p = this.container;
            ...
            for (v = 0; v < u.length; v++) {
                ...
                w = F.getBBox();
                var E;
                this.equalWidths ? E = A * (r + n + this.markerLabelGap) : (E = C, C = C + w.width + f + n);
                E + w.width > q && 0 < v && 0 !== A && (t++, E = A = 0, C = E + w.width + f + n, x = x + z + m, z = 0);
            ...
            w = B.getBBox();
            l = w.height + 2 * m - 1;
            "left" == a || "right" == a ? (n = w.width + 2 * f, k = n + b + c, h.style.width = k + "px", this.ieW = k) : n = k - b - c - 1;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                n || (n = b.customMarker);
                var q = b.container, r = b.markerSize, t = 0, p = 0, y = r / 2;
                if (e) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) m = q.set(), a.hidden || (f = a.lineColorR, k = a.bulletBorderColorR), t = d.line(q, [0, 2 * r], [r / 2, r / 2], f, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, t, "graph-stroke"), m.push(t), a.bullet && (a.hidden || (f = a.bulletColorR), t = d.bullet(q, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, k, a.bulletBorderAlpha)) && (d.setCN(c, t, "graph-bullet"), t.translate(r + 1, r / 2), m.push(t)), y = 0, t = r, p = r / 3; else {
                ...
                } else if (n) m = q.image(n, 0, 0, r, r); else {
                    var B;
                    isNaN(b.gradientRotation) || (B = 180 + b.gradientRotation);
                    (m = b.createMarker(g, f, h, void 0, void 0, void 0, B, l)) && m.translate(r / 2, r / 2)
                }
                ...
                k = b.switchType;
                var u;
                k && "none" != k && 0 < r && ("x" == k ? (u = b.createX(), u.translate(r / 2, r / 2)) : u = b.createV(), u.dItem = a, !0 !== a.hidden ? "x" == k ? u.hide() : u.show() : "x" != k && u.hide(), b.switchable || u.hide(), b.addListeners(u, a), a.legendSwitch = u, q.push(u), d.setCN(c, u, "legend-switch"));
                k = b.color;
                ...
                l = b.fontSize;
                m && (r <= l && (r = r / 2 + b.ly - l / 2 + (l + 2 - r) / 2 - p, m.translate(y, r), u && u.translate(u.x, r)), a.legendEntryWidth = m.getBBox().width);
                var w;
                f && (f = d.fixBrakes(f), a.legendTextReal = f, w = b.labelWidth, w = isNaN(w) ? d.text(b.container, f, k, c.fontFamily, l, "start") : d.wrappedText(b.container, f, k, c.fontFamily, l, "start", !1, w, 0), d.setCN(c, w, "legend-label"),
                    w.translate(b.lx + t, b.ly), q.push(w), b.labelDx = t, c = w.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
                b.entries[b.index] = q;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (b.valueText && 0 < b.valueWidth) {
                    ...
                    var k = b.valueText, g = g + b.lx + b.labelDx + b.markerLabelGap +
                        b.valueWidth, l = "end";
...
(function () {
    ...
    d.AmMap = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            this.mapContainer.translate(b +
                (this.finalX - b) * e, c + (this.finalY - c) * e, a, !0);
            ...
            if (this.chartCreated && !this.preventHover && (this.initialTouchZoom = this.zoomLevel(), this.dragMap && (this.stopAnimation(), this.mapContainerClickX = this.mapContainer.x, this.mapContainerClickY = this.mapContainer.y), a || (a = window.event), a.shiftKey && !0 === this.developerMode && this.getDevInfo(), a && a.touches)) {
                ...
                e && this.panEventsEnabled && this.boundingRect && (a = e.clientX - this.boundingRect.left, e = e.clientY - this.boundingRect.top, this.middleXP = (b + (a - b) / 2) / this.realWidth, this.middleYP = (c + (e - c) / 2) / this.realHeight,
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    var m = b.realHeight, n = b.realWidth, q = b.mapWidth, r = b.mapHeight;
                    b.mouseIsDown && b.dragMap && (3 < Math.abs(b.previuosMouseX - b.mouseX) || 3 < Math.abs(b.previuosMouseY - b.mouseY)) && (b.isDragging = !0);
                    if (!isNaN(k)) {
                        b.stopDrag();
                        var t = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - f, 2)), p = b.initialDistance;
                        isNaN(p) && (p = Math.sqrt(Math.pow(k - g, 2) +
                            Math.pow(l - f, 2)));
                        if (!isNaN(p)) {
                            var k = b.initialTouchZoom * t / p, k = d.fitToBounds(k, h.minZoomLevel, h.maxZoomLevel), h = b.zoomLevel(), p = b.middleXP, l = b.middleYP, t = m / r, y = n / q, p = (b.zoomX() - p * y) * (k / h) + p * y, l = (b.zoomY() - l * t) * (k / h) + l * t;
                            .1 < Math.abs(k - h) && (b.zoomTo(k, p, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    k = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (g - c), e = a.y + (f - e), b.preventDragOut && (r = -r * k + m / 2 - b.diffY * b.mapScale * k, m = m / 2 - b.diffY * b.mapScale * k, c = d.fitToBounds(c, -q * k + n / 2, n / 2), e = d.fitToBounds(e, r, m)), isNaN(c) || isNaN(e) || (a.translate(c, e, k, !0), b.updateSmallMap()));
                    b.previuosMouseX = g;
                    b.previuosMouseY = f
                }
            }
            ...
            if (b) {
                ...
                var e = a.alphaReal, g = a.outlineAlphaReal, f = a.outlineThicknessReal, h = a.outlineColorReal;
                if (a.showAsSelected) {
                ...
                if (k = a.image) k.setAttr("fill", c), k.setAttr("stroke", h), k.setAttr("stroke-width", f), k.setAttr("fill-opacity", e), k.setAttr("stroke-opacity", g);
                "MapArea" == a.objectType && (c = 1, this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel() * this.mapScale), b.setAttr("stroke", h), b.setAttr("stroke-width", f / c), b.setAttr("fill-opacity", e), b.setAttr("stroke-opacity", g));
            ...
            if (a) {
                var b =
                    a.zoomLatitude, c = a.zoomLongitude;
            ...
            for (e = 0; e < a.length; e++) {
                ...
                if (this.areasSettings.preserveOriginalAttributes) {
                    k.customAttr = {};
                    for (var l in g)"d" != l && "id" != l && "title" != l && (k.customAttr[l] = g[l])
                }
                g.outline && (k.outline = !0);
                k.path = f;
                this.svgAreasById[g.id] = {area: k, title: h, className: g["class"]};
            ...
            return (this.longitudeToCoordinate(a) + this.diffX * this.mapScale) * this.zoomLevel() +
                this.mapContainer.x
        ...
        stageYToLatitude: function (a) {
            ...
            void 0 == g && (g = "");
            var f = b.value, f = isNaN(f) ? "" : d.formatNumber(f, c), c = b.percents, c = isNaN(c) ? "" : d.formatNumber(c,
                    e), e = b.description;
            void 0 == e && (e = "");
            var h = b.customData;
            void 0 == h && (h = "");
            ...
            return this.mapSet ?
                Math.round(1E4 * this.mapContainer.y / this.mapHeight) / 1E4 : NaN
        }, goHome: function () {
            this.selectObject(this.dataProvider);
            ...
            if (a) {
                ...
                if (b) d.getURL(b, a.urlTarget); else if (b = a.linkToObject) {
                    ...
                    b && a.passZoomValuesToTarget &&
                    (b.zoomLatitude = this.zoomLatitude(), b.zoomLongitude = this.zoomLongitude(), b.zoomLevel = this.zoomLevel());
            ...
            if (this.mapContainer) {
                var a = this.mapSet.getBBox(),
                    b = (-this.mapContainer.x + this.previousWidth / 2) / this.zoomLevel() - a.x * this.mapScale, a = (-this.mapContainer.y + this.previousHeight / 2) / this.zoomLevel() - a.y * this.mapScale;
            ...
            if (c) {
                ...
                for (g = 0; g < k; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)if (3 == f.nodeType || 4 == f.nodeType) {
                        if ("" !== m) {
                            f = 0;
                            for (h in a[b])a[b].hasOwnProperty(h) && f++;
                            f ? a[b]["#text"] = m : a[b] = m
                        }
                        ...
                        if (f.attributes && f.attributes.length)for (m = 0; m < f.attributes.length; m++)q[f.attributes[m].name] = f.attributes[m].value;
            ...
            var a = this.zoomLevel(), b = this.mapSet.getBBox(), b = this.xyToCoordinates((this.mouseX - this.mapContainer.x) / a - b.x * this.mapScale, (this.mouseY - this.mapContainer.y) / a - b.y * this.mapScale), a = {
                chart: this,
                type: "writeDevInfo",
                zoomLevel: a,
                zoomX: this.zoomX(),
            ...
            return Math.round(this.unscaledMapHeight * (a - b) / (this.dataProvider.bottomLatitude -
                    b) * 100) / 100
            ...
            for (var c = 0; c < b.length; c++) {
                ...
                if (d) {
                    for (var d = d.split("L"), g = [], f = 0; f < d.length; f++)if (d[f]) {
                        var h = d[f].split(" "), h = this.xyToCoordinates(Number(h[1]), Number(h[2]), this.dpProjectionFunction, this.sourceMapWidth, this.sourceMapHeight);
            ...
            for (var b = !1, c = "", e = 0; e < a.length; e++) {
                ...
                h < this.minMapXX && (this.minMapXX = h, this.leftLongLat = {longitude: g, latitude: f});
                h > this.maxMapXX && (this.maxMapXX = h, this.rightLongLat = {longitude: g, latitude: f});
                k < this.minMapYY && (this.minMapYY = k, this.topLongLat = {longitude: g, latitude: f});
                k > this.maxMapYY && (this.maxMapYY = k, this.bottomLongLat = {longitude: g, latitude: f});
                b ? c += " L " : (c += " M ", b = !0);
                c += h + " " + k
            }
            return c + " Z "
        }, normalizeMap: function () {
            var a = d.degreesToRadians(this.dataProvider.leftLongitude), b = d.degreesToRadians(this.dataProvider.rightLongitude), c = d.degreesToRadians(this.dataProvider.topLatitude), e = d.degreesToRadians(this.dataProvider.bottomLatitude), g = a + (b - a) / 2, f = c + (e - c) / 2, h = this.dpProjectionFunction(g, c)[1], k = this.dpProjectionFunction(g, e)[1], l = this.dpProjectionFunction(a, f)[0], m = this.dpProjectionFunction(b, f)[0], c = d.equirectangular(g, c), e = d.equirectangular(g, e), h = (c[1] - e[1]) / (h - k), a = d.equirectangular(a, f), b = d.equirectangular(b, f),
                l = (a[0] - b[0]) / (l - m);
            ...
            this.unscaledMapHeight = this.sourceMapHeight *
                h;
            this.diffY = this.diffX = 0
        }, fixMapPosition: function () {
            var a = d.degreesToRadians(this.dataProvider.leftLongitude), b = d.degreesToRadians(this.dataProvider.rightLongitude), c = d.degreesToRadians(this.dataProvider.topLatitude), e = d.degreesToRadians(this.dataProvider.bottomLatitude), g = a + (b - a) / 2, f = c + (e - c) / 2, h = this.dpProjectionFunction(g, c)[1], k = this.dpProjectionFunction(g, e)[1], l = this.dpProjectionFunction(a, f)[0], m = this.dpProjectionFunction(b, f)[0];
            this.sourceMapHeight = this.mapHeight / this.mapScale;
            this.sourceMapWidth =
                this.mapWidth / this.mapScale;
            ...
            for (e = 0; e < this.svgAreas.length; e++)this.svgAreas[e].translate(this.diffX,
                this.diffY)
            ...
            if (f = c.invert) {
                var h = this.dataProvider.leftLongitude, k = this.dataProvider.rightLongitude, l = this.dataProvider.topLatitude, m = this.dataProvider.bottomLatitude, n = h + (k - h) / 2, q = l + (m - l) / 2, l = d.radiansToDegrees(c(d.degreesToRadians(n), d.degreesToRadians(l))[1]), m = d.radiansToDegrees(c(d.degreesToRadians(n),
                    d.degreesToRadians(m))[1]), h = d.radiansToDegrees(c(d.degreesToRadians(h), d.degreesToRadians(q))[0]), k = d.radiansToDegrees(c(d.degreesToRadians(k), d.degreesToRadians(q))[0]);
...
(function () {
    ...
    d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            var g = c.buttonSize, f = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor, l = c.buttonFillAlpha, m = c.buttonBorderThickness, n = c.buttonBorderColor, q = c.buttonBorderAlpha, r = c.buttonCornerRadius, t = c.buttonRollOverColor, p = c.gridHeight, y = c.zoomFactor, B = c.minZoomLevel, u = c.maxZoomLevel, w = c.buttonIconAlpha, v = c.buttonIconColor, A = c.roundButtons, C = a.svgIcons, x = a.getX(c.left), z = a.getY(c.top);
            isNaN(c.right) || (x = a.getX(c.right, !0), x = h ? x - 3 * g : x - g);
            isNaN(c.bottom) || (z = a.getY(c.bottom, !0), f && (z -= p + 3 * g), z = h ? z - 3 * g : c.homeButtonEnabled ? z - .5 * g : z + g);
            e.translate(x, z);
            c.previousDY = NaN;
            var F, x = g / 4 - 1;
            if (f) {
                ...
                c.set = e;
                c.zoomSet = F;
                5 < p && (f = d.rect(b, g + 6, p + 2 * g + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, "#000000", 0, 4), d.setCN(a, f, "zoom-bg"), f.translate(-3, -3), f.mouseup(function () {
                    c.handleBgUp()
                }).touchend(function () {
                    c.handleBgUp()
                }), F.push(f));
                ...
                F.push(D);
                for (G = 1; G < H; G++)z = g + G * f, z = d.line(b, [1, E - 2], [z, z], c.gridColor, c.gridAlpha, 1), d.setCN(a, z, "zoom-grid"), D.push(z);
                z = new d.SimpleButton;
                z.setDownHandler(c.draggerDown, c);
                z.setClickHandler(c.draggerUp, c);
                z.init(b, E, f, k, l, m, n, q, r, t);
                ...
                z.init(b, g, g, k, l, m, n, q, r, t, w, v, A);
                ...
                z.init(b, g, g, k, l, m, n, q, r, t, w, v, A);
                z.set.translate(0, p + g);
                d.setCN(a, z.set, "zoom-out");
                F.push(z.set);
                p -= f;
                u = Math.log(u / 100) / Math.log(y);
                c.realStepSize = p / (u - Math.log(B / 100) / Math.log(y));
                c.realGridHeight = p;
                c.stepMax = u
            }
            h && (h = b.set(), d.setCN(a, h, "zoom-control-pan"), e.push(h), F && F.translate(g, 4 * g), y = new d.SimpleButton, C ? y.svgIcon = d.line(b, [x / 5, -x + x / 5,
                    x / 5], [-x, 0, x], v, w, 1) : y.setIcon(a.pathToImages + "panLeft.gif", c.iconSize), y.setClickHandler(a.moveLeft, a), y.init(b, g, g, k, l, m, n, q, r, t, w, v, A), y.set.translate(0, g), d.setCN(a, y.set, "pan-left"), h.push(y.set), y = new d.SimpleButton, C ? y.svgIcon = d.line(b, [-x / 5, x - x / 5, -x / 5], [-x, 0, x], v, w, 1) : y.setIcon(a.pathToImages + "panRight.gif", c.iconSize), y.setClickHandler(a.moveRight, a), y.init(b, g, g, k, l, m, n, q, r, t, w, v, A), y.set.translate(2 * g, g), d.setCN(a, y.set, "pan-right"), h.push(y.set), y = new d.SimpleButton, C ? y.svgIcon = d.line(b, [-x, 0, x], [x / 5, -x + x / 5, x / 5], v, w, 1) : y.setIcon(a.pathToImages + "panUp.gif", c.iconSize), y.setClickHandler(a.moveUp, a), y.init(b, g, g, k, l, m, n, q, r, t, w, v, A), y.set.translate(g, 0), d.setCN(a, y.set, "pan-up"), h.push(y.set), y = new d.SimpleButton, C ? y.svgIcon = d.line(b, [-x, 0, x], [-x / 5, x - x / 5, -x / 5], v, w, 1) : y.setIcon(a.pathToImages + "panDown.gif", c.iconSize), y.setClickHandler(a.moveDown, a), y.init(b, g, g, k, l, m, n, q, r, t, w, v, A), y.set.translate(g, 2 * g), d.setCN(a, y.set, "pan-down"), h.push(y.set), e.push(h));
            c.homeButtonEnabled && (h = new d.SimpleButton, C ? h.svgIcon = d.polygon(b, [-x, 0, x, x - 1, x - 1, 2, 2, -2, -2, -x + 1, -x + 1], [0, -x, 0, 0, x - 1, x - 1, 2, 2, x - 1, x - 1, 0], v, w, 1, v, w) : h.setIcon(a.pathToImages + c.homeIconFile, c.iconSize), h.setClickHandler(a.goHome, a), c.panControlEnabled && (q = l = 0), h.init(b, g, g, k, l, m, n, q, r, t, w, v, A), c.panControlEnabled ? h.set.translate(g, g) : F && F.translate(0, 1.5 * g), d.setCN(a, h.set, "pan-home"), e.push(h.set));
            c.update()
...
(function () {
    ...
    d.SimpleButton = d.Class({
        construct: function () {
        }, init: function (a, b, c, e, g, f, h, k, l, m, n, q, r) {
            var t = this;
            t.rollOverColor = m;
            t.color = e;
            t.container = a;
            m = a.set();
            t.set = m;
            r ? (b /= 2, e = d.circle(a, b, e, g, f, h, k), e.translate(b, b)) : e = d.rect(a, b, c, e, g, f, h, k, l);
            m.push(e);
            g = t.iconPath;
            var p;
            g && (p = t.iconSize, f = (b - p) / 2, r && (f = (2 * b - p) / 2), p = a.image(g, f, (c - p) / 2, p, p));
            t.svgIcon && (p = t.svgIcon, r ? p.translate(b, b) : p.translate(b / 2, b / 2));
    ...
    d.SmallMap = d.Class({
        construct: function (a) {
            ...
            if (c.enabled) {
                ...
                a.svgIcons ? r.svgIcon = d.line(b, [-q / 2, 0, q / 2], [q / 4, -q / 4, q / 4], c.iconColor, 1, 1) : r.setIcon(a.pathToImages + "arrowUp.gif", k);
                ...
                isNaN(c.right) || (m = a.getX(c.right, !0) - c.width - f, t = c.width - k + f / 2);
                f = b.set();
...
(function () {
    ...
    d.AreasProcessor = d.Class({
        construct: function (a) {
            ...
            var b = this.chart;
            b.outlines = [];
            var c = a.length, d, g, f = 0, h = !1, k = !1, l = 0;
            ...
            b.minValueReal = k;
            for (d =
                     0; d < c; d++)g = a[d], isNaN(g.value) ? g.percents = void 0 : (g.percents = (g.value - k) / f * 100, k == h && (g.percents = 100));
            ...
            for (n = 0; n < h.length; n++) {
                ...
                if (b.preserveOriginalAttributes) {
                    if (l.customAttr)for (var q in l.customAttr)l.setAttr(q,
                        l.customAttr[q])
                } else {
            ...
            var f = e.color, h = e.alpha, k = e.outlineThickness, l = e.rollOverColor, m = e.selectedColor, n = e.rollOverAlpha, q = e.rollOverBrightness, r = e.outlineColor, t = e.outlineAlpha, p = e.balloonText, y = e.selectable, B = e.pattern, u = e.rollOverOutlineColor, w = e.bringForwardOnHover, v = e.preserveOriginalAttributes;
            ...
            if (c && (q = c.area, w = c.title, a.enTitle = c.title, w && !a.title && (a.title = w), (c = b.language) ? (w = d.mapTranslations) && (c = w[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, q)) {
                c = a.tabIndex;
                void 0 === c && (c = e.tabIndex);
                void 0 !== c && q.setAttr("tabindex", c);
                a.displayObject = q;
                a.outline && (A = 0, a.alphaReal = 0, a.rollOverAlphaReal = 0, a.mouseEnabled = !1, b.outlines.push(q), q.node.setAttribute("pointer-events", "none"));
                ...
                (q.setAttr("fill", C), q.setAttr("stroke", f), q.setAttr("stroke-opacity", r), q.setAttr("stroke-width", t), q.setAttr("fill-opacity", A));
...
(function () {
    ...
    d.ImagesProcessor = d.Class({
        construct: function (a) {
            ...
            a.remove && a.remove();
            var k = h.color, l = h.alpha, m = h.rollOverColor, n = h.rollOverOutlineColor, q = h.selectedColor, r = h.balloonText, t = h.outlineColor, p = h.outlineAlpha, y = h.outlineThickness, B = h.selectedScale, u = h.rollOverScale, w = h.selectable, v = h.labelPosition, A = h.labelColor, C = h.labelFontSize, x = h.bringForwardOnHover, z = h.labelRollOverColor, F = h.rollOverBrightness, E = h.selectedLabelColor;
            a.index = b;
            a.chart = c;
            ...
            if (n) {
                ...
                p = F = 0;
                a.centeredReal ? (isNaN(a.right) || (F = C * w), isNaN(a.bottom) || (p = E * w)) : (F = C * w / 2, p = E * w / 2);
                D.translate(F, p, w, !0)
            ...
            var n = a.imageLabel, q = this.chart.zoomLevel(), r, t;
            a.lineId && (a.line = this.chart.getObjectById(a.lineId));
            b.makeObjectAccessible(a);
            var p = a.tabIndex;
            void 0 === p && (p = b.imagesSettings.tabIndex);
            void 0 !== p && c.setAttr("tabindex", p);
            a.line && a.line.getCoordinates && (a.line.chart = b, p = a.line.getCoordinates(m, a.lineSegment)) && (k = b.coordinateToLongitude(p.x), l = b.coordinateToLatitude(p.y), r = p.x, t = p.y, a.animateAngle && (f = d.radiansToDegrees(p.angle)));
            isNaN(f) || c.rotate(f + a.extraAngle);
            isNaN(e) || isNaN(g) ? isNaN(l) || isNaN(k) || (g = b.coordinatesToXY(k, l), e = g.x, g = g.y, isNaN(r) || (e = r), isNaN(t) || (g = t), a.fixedSize ? (r = a.positionScale, isNaN(r) ? r = 0 : (--r, r *= 1 - 2 * Math.abs(m - .5)), m = {
                        image: c,
                        scale: 1 + r,
                        mapImage: a
                    }, h.push(m), a.arrays.push({
                        arr: h,
                        el: m
                    }), c.translate(e, g, 1 / q + r, !0)) : (c.translate(e, g, NaN, !0), n && (this.labelsToReposition.push(a), a.arrays.push({
            ...
            if (a) {
                ...
                d && (k = d.getBBox(), f = d.y + k.y, g = d.x + k.x, h = k.width, k = k.height, b.svgPath && (h *= b.scale, k *= b.scale));
...
(function () {
    ...
    d.LinesProcessor = d.Class({
        construct: function (a) {
            ...
            a.index = b;
            a.remove && a.remove();
            var c = this.chart, e = c.linesSettings, g = this.objectsToResize, f = c.mapLinesContainer, h = c.stageLinesContainer, k = e.thickness, l = e.dashLength, m = e.arrow, n = e.arrowSize, q = e.arrowColor, r = e.arrowAlpha, t = e.color, p = e.alpha, y = e.rollOverColor, B = e.selectedColor, u = e.rollOverAlpha, w = e.balloonText, v = e.bringForwardOnHover, A = e.arc, C = e.rollOverBrightness, x = c.container;
            a.chart = c;
            a.baseSettings = e;
            var z = x.set();
            a.displayObject = z;
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                e = a.latitudes;
                p = n.length;
                if (0 < p)for (v = [], C = [], u = 0; u < p; u++)B = c.coordinatesToXY(n[u], e[u]), v.push(B.x), C.push(B.y);
                if (0 < v.length) {
                    a.segments = v.length;
                    d.dx = 0;
                    d.dy = 0;
                    var E, H, G, p = 10 * (1 - Math.abs(w));
                    10 <= p && (p = NaN);
                    1 > p && (p = 1);
                    a.arcRadius = [];
                    a.distances = [];
                    ...
                    if (isNaN(p)) {
                        for (p = 0; p < v.length - 1; p++)H = Math.sqrt(Math.pow(v[p + 1] - v[p], 2) + Math.pow(C[p + 1] - C[p], 2)), a.distances[p] = H;
                        p = d.line(x, v, C, l, 1, F / n, k, !1, !1, !0);
                        l = d.line(x, v, C, l, .001, 5 / n, k, !1, !1, !0);
                        p.setAttr("stroke-linecap", "round")
                    } else {
                        u = 1;
                        0 > w && (u = 0);
                        B = {
                    ...
                    if ("none" != A) {
                        ...
                        "both" == A && (r = d.polygon(x, t, k, m, q, 1, m, q, void 0, !0), z.push(r), r.translate(M, N, 1 / n, !0), isNaN(I) || r.rotate(I), d.setCN(c, p, "map-line-arrow"), void 0 != a.id && d.setCN(c, p, "map-line-arrow-" + a.id), a.fixedSize && g.push(r));
                        ...
                        r = d.polygon(x, t, k, m, q, 1, m, q, void 0, !0);
                        ...
                        r.translate(M,
                            N, 1 / n, !0);
                        isNaN(I) || r.rotate(I);
                        a.fixedSize && (g.push(r), a.arrays.push({arr: g, el: r}));
                        a.arrowSvg = r
                    }
                    a.fixedSize && p && (g = {
                        line: p,
                    ...
                    a.lineSvg = p;
                    a.showAsSelected && !isNaN(y) && p.setAttr("stroke", y);
                    0 < e.length ? f.push(z) : h.push(z);
                    a.hidden && z.hide();
        ...
        inherits: d.MapObject, construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (1 < this.longitudes.length) {
                    ...
                    e = e.y;
                    f = l.y
                } else 1 < this.x.length && (c = this.x[b], g = this.x[b + 1], e = this.y[b], f = this.y[b + 1]);
...
(function () {
    ...
    d.normalizePath = function (a) {
        for (var b = "", c = d.parsePath(a.getAttribute("d")), e, g, f = Infinity, h = -Infinity, k = Infinity, l = -Infinity, m = 0; m < c.length; m++) {
            var n = c[m], q = n.letter, r = n.x, n = n.y;
            "h" == q && (q = "L", r += e, n = g);
            "H" == q && (q = "L", n = g);
            "v" == q && (q = "L", r = e, n += g);
            "V" == q && (q = "L", r = e);
            if ("m" === q || "l" === q) q = q.toUpperCase(), r += e, n += g;
            r = d.roundTo(r, 3);
            n = d.roundTo(n, 3);
            e = r;
            g = n;
            ...
            n > l && (l = n);
            n < k && (k = n);
            b = "z" == q.toLowerCase() ? b + "Z " : b + (q + " " + r + " " + n + " ")
        }
        a.setAttribute("d", b);
        return {minX: f, maxX: h, minY: k, maxY: l}
    };
    ...
    d.winkel3.invert = function (a, b) {
        ...
        do var h = Math.cos(e), k = Math.sin(e),
            l = Math.sin(2 * e), m = k * k, n = h * h, q = Math.sin(c), r = Math.cos(c / 2), t = Math.sin(c / 2), p = t * t, y = 1 - n * r * r, B = y ? d.acos(h * r) * Math.sqrt(u = 1 / y) : u = 0, u, y = .5 * (2 * B * h * t + c / f) - a, w = .5 * (B * k + e) - b, v = .5 * u * (n * p + B * h * r * m) + .5 / f, A = u * (q * l / 4 - B * k * t), k = .125 * u * (l * t - B * k * n * q), m = .5 * u * (m * r + B * p * h) + .5, h = A * k - m * v, A = (w * A - y * m) / h, y = (y * k - w * v) / h, c = c - A, e = e - y; while ((1E-6 < Math.abs(A) || 1E-6 < Math.abs(y)) && 0 < --g);
        return [c, e]
    };
    ...
    d.ValueLegend = d.Class({
        construct: function (a) {
            ...
            if (this.enabled) {
                ...
                var h = 0, k = this.minValue, l = this.fontSize, m = a.fontFamily, n = this.color, q = {
                    precision: a.precision,
                    decimalSeparator: a.decimalSeparator,
                    thousandsSeparator: a.thousandsSeparator
                };
                void 0 == k && (k = d.formatNumber(a.minValueReal, q));
                void 0 !== k && (h = d.text(b, k, n, m, l, "left"), h.translate(0, l / 2 - 1), d.setCN(a, h, "value-legend-min-label"), f.push(h), h = h.getBBox().height);
                k = this.maxValue;
                void 0 === k && (k = d.formatNumber(a.maxValueReal, q));
